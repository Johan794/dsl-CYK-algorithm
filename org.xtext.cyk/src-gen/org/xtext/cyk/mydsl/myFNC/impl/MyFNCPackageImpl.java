...
import org.xtext.cyk.mydsl.myFNC.MyFNCFactory;
 ...
 * @generated
 */
public class MyFNCPackageImpl extends EPackageImpl implements MyFNCPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.cyk.mydsl.myFNC.MyFNCPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private MyFNCPackageImpl()
  {
    super(eNS_URI, MyFNCFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link MyFNCPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static MyFNCPackage init()
  {
    if (isInited) return (MyFNCPackage)EPackage.Registry.INSTANCE.getEPackage(MyFNCPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredMyFNCPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    MyFNCPackageImpl theMyFNCPackage = registeredMyFNCPackage instanceof MyFNCPackageImpl ? (MyFNCPackageImpl)registeredMyFNCPackage : new MyFNCPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theMyFNCPackage.createPackageContents();

    // Initialize created meta-data
    theMyFNCPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theMyFNCPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(MyFNCPackage.eNS_URI, theMyFNCPackage);
    return theMyFNCPackage;
  }
   ...
   */
  @Override
  public EReference getGNFC_Final()
  {
   ...
   */
  @Override
  public EAttribute getLambda_Rigth()
  {
   ...
   */
  @Override
  public EAttribute getInputString_Input()
  {
   ...
   */
  @Override
  public MyFNCFactory getMyFNCFactory()
  {
    return (MyFNCFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(gnfcEClass, GNFC__FINAL);
    ...
    createEAttribute(lambdaEClass, LAMBDA__RIGTH);
    ...
    createEAttribute(inputStringEClass, INPUT_STRING__INPUT);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getGNFC_Init(), this.getInitial(), null, "init", null, 0, 1, org.xtext.cyk.mydsl.myFNC.GNFC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getGNFC_Productions(), this.getProduction(), null, "productions", null, 0, -1, org.xtext.cyk.mydsl.myFNC.GNFC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getGNFC_Final(), this.getInputString(), null, "final", null, 0, 1, org.xtext.cyk.mydsl.myFNC.GNFC.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getInputString_Input(), ecorePackage.getEString(), "input", null, 0, 1, InputString.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
